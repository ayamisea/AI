...
int main()
{
    ...
    if(game.first=="y")
    {
        ...
        if(game.getBoard().PositionExist(pos.row,pos.col)) game.setP1No(game.getBoard().board[pos.row][pos.col]);
        if(game.getBoard().performMove(pos,game.getP1No())) std::cout<<"Attack!!\n";
